...
export default function About() {
  return (
    <section className="" id="about">
      <div className="container py-36 flex flex-col lg:flex-row gap-8">
        <div className="max-w-lg">
          <h2 className="text-sec font-bold">ABOUT ME</h2>
          <p className="font-bold text-3xl leading-8 my-4">
          ...
          <p className="text-text">
            ...
            player who thrives in collaborating with other developers to produce
            outstanding web applications.
          </p>
        </div>
        <div className="">
          <div className="flex flex-wrap gap-4  items-center mt-16">
            <p className=" font-semibold text-xl p-1  md:mx-0 mx-auto ">
              TECH{" "}
            </p>
            <ul className="flex flex-wrap gap-8">
              <li className="  " title="HTML">
                <svg
                ...
                <p className="mt-1 font-semibold">HTML</p>
              </li>
              <li className="" title="CSS">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="
#2965f1 "
                ...
                <p className="mt-1 font-semibold">CSS</p>
              </li>
              <li className="" title="Javascript">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="#f0db4f"
                  viewBox="0 0 448 512"
                ...
                <p className="mt-1 font-semibold">Javascript</p>
              </li>
              <li className="  w-10 h-10 " title="React">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  fill="#61dbfb "
              ...
              <li className="" title="Sass">
                ...
                <p className="mt-1 font-semibold">Sass</p>
              </li>

              <li className="" title="Firebase">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                >
                  ...
                  <g clip-path="url(#id2)">
                    <path
                      fill="rgb(96.078491%, 49.798584%, 9.01947%)"
                  ...
                  <g clip-path="url(#id3)">
                    <path
                      fill="rgb(100%, 79.219055%, 15.689087%)"
                ...
                <p className="mt-1 font-semibold">Firebase</p>
              </li>
            </ul>
          </div>
        </div>
